...
export const Logo = ({
  ...
  const widthValue = width || 54;
  const heightValue = height || 32;
...
export const LogoText = ({
  ...
  const widthValue = width || 44;
  const heightValue = height || 32;

  return (
    <div className="flex gap-1">
      <LogoIcon width={widthValue} height={heightValue} />

      <div className="flex-center flex-col font-bokcero text-xl leading-none">
...
export const AnimatedLogoText = ({
  ...
  return (
    <div className="flex gap-1">
      ...
      <div className="flex flex-col justify-center items-start font-bokcero text-6xl leading-none">
        <TextRoll
